// tests/google.ts - Google search demo using Vibium 0.1.3
...
const browserTyped = browser as VibiumBrowser;

async function runDemo() {
    // 1. Khởi tạo Vibium (Tự động tải Driver nếu thiếu ở bản 0.1.3)
    const vibe = await browserTyped.launch({
    ...
    try {
        ...
        try {
            ...
            console.log("Could not extract search results:", (e as Error).message);
        }
